...
public class PurFileObject extends AbstractFileObject<PurFileSystem> {

  private static final Logger log = LoggerFactory.getLogger( PurFileObject.class );
  ...
  protected PurFileObject( AbstractFileName fileName, PurFileSystem fileSystem, RepositoryFile file ) {
  ...
  protected boolean doIsSameFile( FileObject destFile ) throws FileSystemException {
    ...
    if ( destFile instanceof PurFileObject localDestFile ) {
