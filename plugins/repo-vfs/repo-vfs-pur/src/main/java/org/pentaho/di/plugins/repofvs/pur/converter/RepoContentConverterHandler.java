...
public class RepoContentConverterHandler implements IRepositoryContentConverterHandler {
  ...
  public Map<String, Converter> getConverters() {
    throw new UnsupportedOperationException( "I gambled this wasn't used, and I lost" );
  }
  ...
  public void addConverter( String extension, Converter converter ) {
    throw new UnsupportedOperationException( "We're not in the 'addConverter' business" );
  }
